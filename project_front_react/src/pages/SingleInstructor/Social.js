    ...
    return (
        ...
        <div className="d-flex flex-wrap align-items-center justify-content-center mb-5 mt-5 mb-md-3">
            ...
            <li className="list-inline-item list-social-item px-2">
                <Link to="#" className="text-secondary w-36 h-36 shadow-dark-hover d-flex align-items-center justify-content-center rounded-circle border-hover">
            ...
            <div className="border rounded-circle d-inline-block mb-4 mb-md-0 mx-lg-4 order-0">
                <div className="p-4">
                    <img src={imaget} alt="..." className="rounded-circle img-fluid" width="170" height="170" />
                </div>
            </div>

            <Link to="#" className="text-teal fw-medium d-flex align-items-center mx-lg-4 order-1 order-md-0">
                {/* Icon */}
