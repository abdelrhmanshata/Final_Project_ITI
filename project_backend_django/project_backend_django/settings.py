...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Home", "url": "admin:index", "permissions": ["user_authentication_app.view_user"]},
        ...
        {"model": "user_authentication_app.User"},
    ...
    "icons": {
        ...
        "courseListAPI.Course": "fas fa-book-reader",
        "courseListAPI.Video": "fas fa-file-video",
        "courseListAPI.Section": "fas fa-folder-open",
        "courseListAPI.Question": "fas fa-pencil-ruler",
        "courseListAPI.Answer": "fas fa-tasks",
        "payment_app.Payment_Course": "fas fa-money-check-alt",
        "reviews.Approval": "fas fa-user-check",
        "reviews.StudentEnrollsInCourse": "fas fa-clipboard-check",
        "reviews.StudentReviewCourse": "fas fa-feather-alt",
        "reviews.StudentReviewTeacher": "fas fa-user-edit",
        "user_authentication_app.User": "fas fa-user-friends"
    ...
    "changeform_format_overrides": {"user_authentication_app.User": "collapsible", "auth.group": "collapsible"},
