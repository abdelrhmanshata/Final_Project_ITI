...
class StudentReviewCourse(models.Model):
    ...
    courseID = models.ForeignKey('courseListAPI.Course', null=True, on_delete=models.CASCADE, related_name='studcoursereviews')
...
class StudentReviewTeacher(models.Model):
    studentID = models.ForeignKey(User, null=True, on_delete=models.SET_NULL, related_name='student_reviews')
    teacherID = models.ForeignKey(User, null=True, on_delete=models.CASCADE, related_name='teacher_reviews')
...
class StudentEnrollsInCourse(models.Model):
    ...
    courseID = models.ForeignKey('courseListAPI.Course', null=True, on_delete=models.CASCADE)
