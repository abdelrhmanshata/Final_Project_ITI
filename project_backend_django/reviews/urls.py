...
urlpatterns = [
    ...
    path('review_for_course/<int:student_id>/<int:course_id>/',views.create_review, name="create_review"),
    # path("<int:id>/delete/", views.delete_review, name="delete_review"),
    path('review_for_course/<int:student_id>/<int:course_id>/',views.delete_review, name="delete_review"),
    ...
    path('course/<int:id>/score/count/', views.count_students_by_score_range, name='count_students_by_score_range'),
